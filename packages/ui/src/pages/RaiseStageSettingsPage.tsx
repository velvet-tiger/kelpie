...
/** The raise pipeline's stage settings, on the shared `StageSettings` editor. */
export function RaiseStageSettingsPage(): React.JSX.Element {
  ...
  return (
    <>
      ...
      <StageSettings
        ...
        onAdd={(label) => {
          createStage.run({ kind: 'raise', label })
        }}
