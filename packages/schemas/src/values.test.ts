...
describe('label records stay in sync with their id arrays', () => {
  it.each([
    ...
    ['PLAN_ITEM_TARGET_TYPE_LABELS', PLAN_ITEM_TARGET_TYPES, PLAN_ITEM_TARGET_TYPE_LABELS],
    ['EVENT_STATUS_LABELS', EVENT_STATUSES, EVENT_STATUS_LABELS],
    ['EVENT_FORMAT_LABELS', EVENT_FORMATS, EVENT_FORMAT_LABELS],
    ['ATTENDANCE_STATUS_LABELS', ATTENDANCE_STATUSES, ATTENDANCE_STATUS_LABELS],
    ['RECORD_TARGET_TYPE_LABELS', RECORD_TARGET_TYPES, RECORD_TARGET_TYPE_LABELS],
